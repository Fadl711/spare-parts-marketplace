...
// import { getSellerById } from "../../data/mock"; // Removed
...
const ChatScreen = () => {
    ...
    const seller = { store_name: "البائع", id: sellerId }; // Mock placeholder until API fetch implemented
