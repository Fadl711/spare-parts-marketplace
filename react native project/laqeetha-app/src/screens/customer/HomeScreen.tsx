...
const Header = () => (
    <View className="flex-row justify-between items-center mb-4">
        <View>
            <Text className="text-gray-400 text-xs font-Cairo">
                مرحباً بك 👋
            </Text>
...
const PartCard = ({ part, onPress }: { part: Part; onPress: () => void }) => (
    ...
    >
        <Text>{part.image_urls}</Text>
        {/* Debug Text - Remove later */}
        {/* <Text className="text-xs">{part.image_urls?.[0]}</Text> */}
                ...
                {makes.length > 0 && (
                    <View className="mb-6">
                        <View className="flex-row justify-between items-center mb-4">
                            ...
                            >
                                <Text className="text-blue-600 font-Cairo">
                                    عرض الكل
                                </Text>
                            </TouchableOpacity>
