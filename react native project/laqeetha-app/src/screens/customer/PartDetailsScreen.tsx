...
const PartDetailsScreen = ({ navigation, route }: Props) => {
    ...
    const formatPrice = (price: number): string => {
        return (price || 0).toLocaleString("ar-YE") + " ر.ي";
    };
    ...
    const handleWhatsApp = () => {
        if (seller.whatsapp) {
            // Assuming seller object has whatsapp field
