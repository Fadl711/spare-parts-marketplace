          ...
          <View className="flex-row flex-wrap mb-3 justify-end">
            <View
              className={`px-3 py-1 rounded-full ml-2 mb-2 ${
                item.condition === "new" ? "bg-green-100" : "bg-yellow-100"
              }`}
            >
              <Text
            ...
            <View
              className={`px-3 py-1 rounded-full ml-2 mb-2 ${
                item.quality === "original" ? "bg-blue-100" : "bg-purple-100"
              }`}
            >
              <Text
                className={`text-xs font-semibold ${
              ...
              >
                {item.quality === "original" ? "🏆 أصلي" : "💼 تجاري"}
              </Text>
            </View>
          </View>
    ...
    <SafeAreaView className="flex-1 bg-gray-50">
      ...
      <View className="flex-row items-center justify-between px-4 py-2 border-b border-gray-100 bg-white shadow-sm">
        ...
        >
          ...
          <Text className="ml-2 text-gray-700 font-medium text-sm">تصفية</Text>
        </TouchableOpacity>
