...
import { MOCK_SELLER_STATS } from '../../data/mock';
...
const DashboardScreen = () => {
  ...
  const stats = MOCK_SELLER_STATS['s1'];

  return (
    <SafeAreaView className="flex-1 bg-gray-50">
      <ScrollView className="flex-1">
        {/* Subscription Banner */}
        <View className="bg-gradient-to-r from-yellow-500 to-yellow-600 mx-4 mt-4 rounded-2xl p-5 shadow-lg">
          ...
          <View className="flex-row justify-between mb-4">
            ...
            <View className="bg-white rounded-2xl p-5 flex-1 ml-2 shadow-sm">
              <View className="items-center">
                ...
                <Text className="text-gray-500 text-sm mb-1">منتجات نشطة</Text>
                <Text className="text-gray-900 text-2xl font-bold">
