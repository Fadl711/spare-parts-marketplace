...
async def run_test():
    ...
    try:
        ...
        # -> Click on 'إنشاء حساب جديد' to go to the registration page.
        frame = context.pages[-1]
        # Click on 'إنشاء حساب جديد' to navigate to registration page
        ...
        frame = context.pages[-1]
        # Click on 'إنشاء الحساب' to submit registration form
